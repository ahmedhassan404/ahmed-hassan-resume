...
const Achievements = () => {
  ...
  return (
    <section id="achievements" className="py-20 px-4 bg-blue-800/20">
      <div className="container mx-auto">
        <h2 className="text-4xl font-bold text-white text-center mb-16">Achievements</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {achievements.map((achievement, index) => (
            <Card key={index} className="bg-slate-800/50 border-blue-700 hover:bg-slate-800/70 transition-all duration-300">
              <CardHeader>
