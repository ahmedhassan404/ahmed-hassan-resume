      ...
      <div className="container mx-auto text-center relative z-10">
        <div className="animate-fadeIn">
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://github.com/ahmedhassan404" className="text-slate-300 hover:text-blue-400 transition-colors">
            ...
            <a href="mailto:ahmedhassanAlegmail.com" className="text-slate-300 hover:text-blue-400 transition-colors">
